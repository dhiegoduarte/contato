...
// config/express.js
console.log('config/express.js');//, new Date(new Date().getTime()).toString());
...
module.exports = function() {
	...
	// middlewar de segurança
	app.use(helmet());
	
	// removendo header que indica qual tecnologia está sendo utilizada pelo servidor.
	...
	// pois a função procura as pastas no diretório raiz contatooh e precisamos
